...
\input{../include/modeling/workflow}
% \input{../include/modeling/workflow-problem}
% \input{../include/modeling/workflow-logic-program}
% \input{../include/modeling/workflow-grounding}
% \input{../include/modeling/workflow-solving}
% \input{../include/modeling/workflow-stable-models}
% \input{../include/modeling/workflow-solution}
% ----------------------------------------------------------------------
\input{../include/modeling/workflow-problem}
% ----------------------------------------------------------------------
\begin{frame}{A case-study: Graph coloring}
  ...
  \end{itemize}
  \centering
  \only<3,4>{\vfill\input{../include/modeling/figures/fig-graph}}
\end{frame}
% ----------------------------------------------------------------------
\input{../include/modeling/workflow-logic-program}
% ----------------------------------------------------------------------
...
\medskip
\begin{center}
\input{../include/modeling/figures/fig-graph-colored}
\end{center}
\end{frame}
% ----------------------------------------------------------------------
\input{../include/modeling/workflow-solution}
