...
\begin{frame}[c]{The traveling salesperson problem (TSP)}
  ...
  \item \structure{Problem Instance} \ A set of cities and distances among them,
    ...
    \smallskip
  \item \structure{Problem Class} \ What is the shortest possible route visiting
...
\lstinputlisting[basicstyle=\small\ttfamily]{../include/modeling/encodings/cities.lp}
\end{frame}
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Traveling salesperson}{Problem encoding, \texttt{tsp.lp}}
\lstinputlisting[basicstyle=\small\ttfamily]{../include/modeling/encodings/tsp-core.lp}
%
\only<2>{\lstinputlisting[basicstyle=\small\ttfamily,linerange=3]{../include/modeling/encodings/tsp-weak-constraint.lp}}
\only<3>{\lstinputlisting[basicstyle=\small\ttfamily,linerange=3]{../include/modeling/encodings/tsp-minimize.lp}}
\end{frame}
% ----------------------------------------------------------------------
...
\lstinputlisting[basicstyle=\small\ttfamily]{../include/modeling/encodings/tsp-compact.lp}
\end{frame}
% ----------------------------------------------------------------------
%
%%% Local Variables:
